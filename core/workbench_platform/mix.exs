...
defmodule Switchyard.Platform.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :switchyard_platform,
      name: "Switchyard Platform",
      description: "Provider registry and catalog helpers for the Switchyard workbench",
      version: "0.1.0",
      elixir: "~> 1.19",
  ...
  defp docs do
    PackageDocs.docs(package_title: "Switchyard Platform")
  end
end
