...
defmodule Switchyard.Transport.Local.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :switchyard_transport_local,
      name: "Switchyard Local Transport",
      description: "In-process local transport seam for the Switchyard daemon",
      version: "0.1.0",
      elixir: "~> 1.19",
  ...
  defp docs do
    PackageDocs.docs(package_title: "Switchyard Local Transport")
  end
end
