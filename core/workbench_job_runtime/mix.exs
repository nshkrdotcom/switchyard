...
defmodule Switchyard.JobRuntime.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :switchyard_job_runtime,
      name: "Switchyard Job Runtime",
      description: "Structured local job lifecycle helpers for Switchyard",
      version: "0.1.0",
      elixir: "~> 1.19",
  ...
  defp docs do
    PackageDocs.docs(package_title: "Switchyard Job Runtime")
  end
end
