...
defmodule Switchyard.Store.Local.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :switchyard_store_local,
      name: "Switchyard Local Store",
      description: "Local JSON snapshot persistence for the Switchyard daemon",
      version: "0.1.0",
      elixir: "~> 1.19",
  ...
  defp docs do
    PackageDocs.docs(package_title: "Switchyard Local Store")
  end
end
