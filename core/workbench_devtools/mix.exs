...
defmodule WorkbenchDevtools.MixProject do
  ...
  def project do
    [
      app: :workbench_devtools,
      name: "Workbench Devtools",
      description:
        "Optional inspection and development tooling for the Switchyard Workbench runtime",
      version: "0.1.0",
      elixir: "~> 1.19",
  ...
  defp docs do
    PackageDocs.docs(package_title: "Workbench Devtools")
  end
end
