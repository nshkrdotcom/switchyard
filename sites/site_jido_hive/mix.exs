...
defmodule Switchyard.Site.JidoHive.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :switchyard_site_jido_hive,
      name: "Switchyard Site Jido Hive",
      description: "Jido Hive site adapter for the Switchyard terminal workbench",
      version: "0.1.0",
      elixir: "~> 1.18",
