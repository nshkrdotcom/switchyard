...
defmodule Switchyard.Site.ExecutionPlane.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :switchyard_site_execution_plane,
      name: "Switchyard Site Execution Plane",
      description: "Execution Plane substrate site for the Switchyard workbench",
      version: "0.1.0",
      elixir: "~> 1.19",
  ...
  defp docs do
    PackageDocs.docs(package_title: "Switchyard Site Execution Plane")
  end
end
